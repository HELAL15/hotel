    ...
    <>
      <section className=' py-10  relative'>
        ...
        <Container sx='relative z-10 h-full'>
          ...
          <form className='mt-8 shadow-md grid grid-cols-2 md:grid-cols-4 gap-4 items-center justify-center p-4 bg-white rounded-2xl md:divide md:divide-x-2  rtl:md:divide-x-reverse'>
