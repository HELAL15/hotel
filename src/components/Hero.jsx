...
const Hero = () => {
  return (
    <>
      <section className='mt-0 py-10 relative'>
        <StyledAnim/>
        <Container sx='relative z-10'>
          <div className={twMerge('grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6 md:gap-8 items-center')}>
            <div className=''>
              ...
              <h1 className='text-5xl text-black capitalize font-semibold'>book your hotel & enjoy with experience</h1>
              <p className='text-neutral-500 my-8 text-xl'>Accompanying us, you have a trip full of experiences. With Chisfis,
                booking accommodation, resort villas, hotels</p>
