          ...
          <div className='flex items-center justify-between h-16'>
            ...
            <nav className='hidden md:flex mx-auto'>
              <ul className='flex items-center gap-5'>
                ...
                <li><NavLink to='/places' className='nav-link'>Places</NavLink></li>
